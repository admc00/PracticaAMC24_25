    ...
    public static void main(String[] args) {
        ...
        do {
            try {
                ...
                System.out.println("7.Comprobar estrategias de un fichero tsp");
                System.out.println("8.Activar/Desactivar peor caso");
                ...
                switch (opcion) {
                    ...
                    case 7 -> Auxiliares.Menu.comprobarEstrategiasFicheroTsp(teclado);
                    case 8 -> peorCaso = !peorCaso;
